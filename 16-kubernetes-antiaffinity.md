...
[kubeadmin@master antiaffinity-webapp]$
```
...
> NOTE: Habíamos visto como escalar un deployment con **kubectl edit deployment webapp-routed --namespace=webapp-routed**.
...
[kubeadmin@master antiaffinity-webapp]$ kubectl get pods --namespace=webapp-antiaffinity -o wide
NAME                                   READY   STATUS    RESTARTS   AGE    IP               NODE               NOMINATED NODE   READINESS GATES
...
[kubeadmin@master antiaffinity-webapp]$ kubectl get events --namespace=webapp-antiaffinity
...
> NOTE: [Assign pod to node](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/)

> NOTE: [POD Lifecycle](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/)

> NOTE: [Pod Topology Spread Constraints](https://kubernetes.io/docs/concepts/workloads/pods/pod-topology-spread-constraints/)

> NOTE: [Advanced Scheduling in Kubernetes](https://kubernetes.io/blog/2017/03/advanced-scheduling-in-kubernetes/)
