...
```console
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get pods --namespace=webapp-routed -o wide
NAME                             READY   STATUS    RESTARTS   AGE   IP               NODE               NOMINATED NODE   READINESS GATES
webapp-routed-865bc5c6b4-fdqzv   1/1     Running   2          8h    192.169.112.15   kubenode1.acme.es   <none>           <none>
[kubeadmin@kubemaster webapp-antiaffinity]$
```

Si lo escalamos:

```console
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl scale --replicas=2 deployment/webapp-routed --namespace=webapp-routed
deployment.apps/webapp-routed scaled
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get pods --namespace=webapp-routed -o wide
NAME                             READY   STATUS    RESTARTS   AGE   IP               NODE               NOMINATED NODE   READINESS GATES
webapp-routed-865bc5c6b4-fdqzv   1/1     Running   2          8h    192.169.112.15   kubenode1.acme.es   <none>           <none>
webapp-routed-865bc5c6b4-wh8gx   0/1     Running   0          12s   192.169.112.21   kubenode1.acme.es   <none>           <none>
[kubeadmin@kubemaster webapp-antiaffinity]$
```
...
```console
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl create namespace webapp-antiaffinity
namespace/webapp-antiaffinity created
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl apply -f antiaffinity-webapp.yaml 
...
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get pods --namespace=webapp-antiaffinity -o wide
NAME                                   READY   STATUS    RESTARTS   AGE    IP               NODE               NOMINATED NODE   READINESS GATES
webapp-antiaffinity-59d4d57956-5wmxr   1/1     Running   0          116s   192.169.22.4     kubenode2.acme.es   <none>           <none>
webapp-antiaffinity-59d4d57956-7x8bc   1/1     Running   0          116s   192.169.112.20   kubenode1.acme.es   <none>           <none>
[kubeadmin@kubemaster webapp-antiaffinity]$
```
...
```console
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get nodes
NAME               STATUS     ROLES                  AGE   VERSION
kubemaster.acme.es     Ready      control-plane,master   10h   v1.20.2
kubenode1.acme.es   Ready      <none>                 9h    v1.20.2
kubenode2.acme.es   NotReady   <none>                 9h    v1.20.2
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get pods --namespace=webapp-antiaffinity -o wide
NAME                                   READY   STATUS        RESTARTS   AGE    IP               NODE               NOMINATED NODE   READINESS GATES
webapp-antiaffinity-59d4d57956-5wmxr   1/1     Terminating   0          30m    192.169.22.4     kubenode2.acme.es   <none>           <none>
webapp-antiaffinity-59d4d57956-7x8bc   1/1     Running       0          30m    192.169.112.20   kubenode1.acme.es   <none>           <none>
webapp-antiaffinity-59d4d57956-859mj   0/1     Pending       0          118s   <none>           <none>             <none>           <none>
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get events --namespace=webapp-antiaffinity
LAST SEEN   TYPE      REASON                 OBJECT                                      MESSAGE
31m         Normal    Scheduled              pod/webapp-antiaffinity-59d4d57956-5wmxr    Successfully assigned webapp-antiaffinity/webapp-antiaffinity-59d4d57956-5wmxr to kubenode2.acme.es
...
31m         Normal    Scheduled              pod/webapp-antiaffinity-59d4d57956-7x8bc    Successfully assigned webapp-antiaffinity/webapp-antiaffinity-59d4d57956-7x8bc to kubenode1.acme.es
...
kubemaster.acme.es     Ready    control-plane,master   10h   v1.20.2
kubenode1.acme.es   Ready    <none>                 9h    v1.20.2
kubenode2.acme.es   Ready    <none>                 9h    v1.20.2
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get pods --namespace=webapp-antiaffinity -o wide
NAME                                   READY   STATUS    RESTARTS   AGE     IP               NODE               NOMINATED NODE   READINESS GATES
webapp-antiaffinity-59d4d57956-7x8bc   1/1     Running   0          35m     192.169.112.20   kubenode1.acme.es   <none>           <none>
webapp-antiaffinity-59d4d57956-859mj   1/1     Running   0          6m16s   192.169.22.5     kubenode2.acme.es   <none>           <none>
[kubeadmin@kubemaster webapp-antiaffinity]$ kubectl get events --namespace=webapp-antiaffinity
LAST SEEN   TYPE      REASON                 OBJECT                                      MESSAGE
35m         Normal    Scheduled              pod/webapp-antiaffinity-59d4d57956-5wmxr    Successfully assigned webapp-antiaffinity/webapp-antiaffinity-59d4d57956-5wmxr to kubenode2.acme.es
...
35m         Normal    Scheduled              pod/webapp-antiaffinity-59d4d57956-7x8bc    Successfully assigned webapp-antiaffinity/webapp-antiaffinity-59d4d57956-7x8bc to kubenode1.acme.es
...
30s         Normal    Scheduled              pod/webapp-antiaffinity-59d4d57956-859mj    Successfully assigned webapp-antiaffinity/webapp-antiaffinity-59d4d57956-859mj to kubenode2.acme.es
